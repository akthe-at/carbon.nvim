...
function M.setup(colors, config)
	...
	theme.highlights = {
		...
		NormalNC = {
			fg = config.dim_inactive and (colors.fg_dark or colors.comment) or colors.fg,
			bg = config.transparent and colors.none
				or (config.dim_inactive and (colors.bg_dark or colors.bg) or colors.bg),
		},
		...
		Comment = { fg = colors.comment, italic = styles.comments.italic },
		...
		Function = vim.tbl_extend("force", { fg = colors.func }, styles.functions),
		...
		["@function.call"] = vim.tbl_extend("force", { fg = colors.func }, styles.functions),
		["@function.macro"] = vim.tbl_extend("force", { fg = colors.func }, styles.functions),
		["@function.method"] = vim.tbl_extend("force", { fg = colors.func }, styles.functions),
		...
		-- CSS Treesitter
		["@property.css"] = { fg = colors.html_attr_alt },
		["@string.css"] = { fg = colors.keyword },
		["@number.css"] = { fg = colors.number },
		["@type.css"] = { fg = colors.func },
		["@function.css"] = { fg = colors.parameter },
		["@constant.css"] = { fg = colors.string },
		["@tag.css"] = { fg = colors.keyword },
		["@attribute.css"] = { fg = colors.html_attr },
		["@punctuation.delimiter.css"] = { fg = colors.fg },
		["@punctuation.bracket.css"] = { fg = colors.fg },
		["@string.plain_value.css"] = { fg = colors.string },
