...
function M.setup(colors, config)
  ...
  theme.highlights = {
    ...
    NormalNC = { fg = colors.fg, bg = config.transparent and colors.none or (config.dim_inactive and colors.cursor_line_bg or colors.bg) },
    ...
    StatusLine = { fg = colors.gutter, bg = colors.class },
    StatusLineNC = { fg = colors.cursor_line_bg, bg = colors.cursor_line_bg },
    ...
    ["@comment.todo"] = { fg = colors.html_attr_alt, bold = true },
    ["@comment.warning"] = { fg = colors.warning },
    ["@constant"] = { fg = colors.variable },
    ["@constant.builtin"] = { fg = colors.variable },
    ["@constant.macro"] = { fg = colors.variable },
    ["@constructor"] = { fg = colors.class },
    ...
    ["@module.builtin"] = { fg = colors.class },
    ...
    SnacksPickerSelected = { bg = colors.cursor_line_bg },
    ...
    phpFunctions = { fg = colors.func, bold = true },
    ...
    phpMethods = { fg = colors.func, bold = true },
